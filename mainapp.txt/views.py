...
def contact(request):
    if request.method == 'POST':
        ...
        user_domain = request.POST.get('user_domain')
        user_age = request.POST.get('user_age')
        user_message = request.POST.get('user_message')

        UserContacts.objects.create(user_name=full_name, user_phone_number=user_phone, user_email=user_email, user_domain=user_domain, user_message=user_message)
